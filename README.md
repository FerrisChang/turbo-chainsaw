...
<div class="input-container pb-3">
  ...
  <div class="row mb-4 justify-content-center">
    ...
    <div class="col-3 d-flex justify-content-center">
      <mat-form-field class="search-form-field">
        ...
        <ng-container *ngIf="searchItems.companyName">
          <button matSuffix mat-icon-button aria-label="Clear" (click)="searchItems.companyName=''">
    ...
    <div class="col-3 d-flex justify-content-center">
      <mat-form-field class="search-form-field">
        ...
        <button matInput type="button" class="dropdown-button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
          <span class="button-content">
            ...
            <span class="button-text">Company Status</span>
          </span>
        </button>
  ...
  <div class="row justify-content-center">
    ...
    <!-- Search Button -->
    <div class="col-3 d-flex justify-content-center">
      <button mat-raised-button color="primary" class="search-button" (click)="startSearch()">Search</button>
    </div>
  </div>
</div>
            ...
            <tbody>
              <ng-container *ngFor="let company of companiesList; index as i">
                <tr (click)="selectCompaniesRow(company.name)" [ngClass]="expandedCompanyinTable === company.name ? 'bg-light' :'bg-white'">
                  ...
                  <td>{{company.type}}</td>
                  <td>
                    <button type="button" class="btn btn-sm status-button" [ngClass]="company.mra_status ==='Approved' ? 'btn-success' : company.mra_status ==='Rejected' ? 'btn-danger' : company.mra_status ==='In Progress' ? 'btn-warning' : 'black'">
                      {{company.mra_status}}
                    </button>
                  </td>
                </tr>
                <tr *ngIf="expandedCompanyinTable == company.name" class="expanded-row">
                  <td colspan="8">
                    <p (click)="showCompanyView(company.country, company.name)" class="view-details-link">
                      <b>Click here to view Company Details for {{expandedCompanyinTable}}</b>
                    </p>
                    <div class="row">
